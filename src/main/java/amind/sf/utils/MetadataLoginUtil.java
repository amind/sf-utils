...
public class MetadataLoginUtil {
    ...
    public static MetadataConnection login(String username, String password, String loginUrl) throws ConnectionException {
        try {
            final String URL = loginUrl==null? "https://test.salesforce.com/services/Soap/c/"+CreateManifestService.SOAP_VERSION: 
                    "https://"+loginUrl+"/services/Soap/c/"+CreateManifestService.SOAP_VERSION;
